-- FMS database setup script for PostgreSQL (from prisma/schema.prisma)
-- Run in SQL Workbench/J or psql

CREATE DATABASE fms_db;\r\n-- Connect to database fms_db, then run the remaining statements.
